    ...
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <p className="text-right mt-8">
          ...
          ซึ่งมีบริการต่างๆมากมาย อย่างหนังสือที่ไม่เคยอ่านและเครื่องดื่มที่ไม่เคยสั่งอย่างแน่นอน เพราะร้านของเรานั้นเต็มไปด้วยความหลากหลายน้อยมาก กลิ่นหนังสือหอมๆที่เหมือนกลิ่นกาแฟ รสชาติกาแฟและเครื่องต่างๆมากมายให้ทุกท่านจะลิ้มชิมรสความละมุนของเครื่องดื่ม
